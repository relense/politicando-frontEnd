...
class MenuBoard extends Component {
  ...
  renderMainRow = (currentView, currentPartie) => {
    ...
    if(this.props.current === HOME)
      data.push(<div key={HOME} className="menuBoardnavElems menuBoardselectedElem mainButtons" onClick={() => this.elemFuncs(HOME)}>ÚLTIMAS NOTÍCIAS</div>);
    else
      data.push(<div key={HOME} className="menuBoardnavElems mainButtons" onClick={() => this.elemFuncs(HOME)}>ÚLTIMAS NOTÍCIAS</div>);

    if(this.props.current  === PARTIES)
      data.push(<div key={PARTIES} className="menuBoardnavElems menuBoardselectedElem mainButtons" onClick={() => this.elemFuncs(PARTIES)}>PARTIDOS</div>);
    else
      data.push(<div key={PARTIES} className="menuBoardnavElems mainButtons" onClick={() => this.elemFuncs(PARTIES)}>PARTIDOS</div>);

    if(this.state.opened === true)
        data.push(this.renderPartieRow())

    // if(this.props.current  === ABOUT)
    //   data.push(<div key={ABOUT} className="menuBoardnavElems menuBoardselectedElem mainButtons" onClick={() => this.elemFuncs(ABOUT)}>SOBRE</div>);
    // else
    //   data.push(<div key={ABOUT} className="menuBoardnavElems mainButtons" onClick={() => this.elemFuncs(ABOUT)}>SOBRE</div>);
